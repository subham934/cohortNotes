...
console.log([1, 2] + 1); // array + number = string (1,21)
...
// these above are stupid output, hence we use typescript
...
ar.push(84);
ar.push(73);
// i can push any number of items in an array , provided that tehy are just number
