import { ChatCompletionRequest, ChatCompletionRequestMessage, ChatCompletionRequestToolChoice } from "@mistralai/mistralai/models/components/chatcompletionrequest.js";
...
declare function convertMessagesToMistralMessages(messages: Array<BaseMessage>): Array<ChatCompletionRequestMessage>;
/**
...
declare class ChatMistralAI<CallOptions extends ChatMistralAICallOptions = ChatMistralAICallOptions> extends BaseChatModel<CallOptions, AIMessageChunk> implements ChatMistralAIInput {
  ...
  frequencyPenalty?: number;
  numCompletions?: number;
  constructor(model: ChatCompletionRequest["model"], fields?: Omit<ChatMistralAIInput, "model">);
