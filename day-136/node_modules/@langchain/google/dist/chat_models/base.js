...
import { settableServiceTier } from "./types.js";
...
import { convertFieldsToServiceTier, convertFieldsToSpeechConfig, convertFieldsToThinkingConfig, convertParamsToPlatformType } from "../converters/params.js";
...
var BaseChatGoogle = class extends BaseChatModel {
	...
	constructor(params) {
		super(params);
		this.params = params;
		this._addVersion("@langchain/google", "0.1.12");
	...
	*/
	...
	getHeaders(options) {
		...
		return {
			...
			...this.platform === "gcp" && typeof fields.serviceTier !== "undefined" && settableServiceTier.includes(fields.serviceTier) ? { "X-Vertex-AI-LLM-Shared-Request-Type": fields.serviceTier } : {},
			...this._customHeaders,
