...
import type { GetLineageGroupPolicyRequest, GetLineageGroupPolicyResponse } from "../models/models_3";
...
declare const GetLineageGroupPolicyCommand_base: {
    new (input: GetLineageGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetLineageGroupPolicyCommandInput, GetLineageGroupPolicyCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetLineageGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetLineageGroupPolicyCommandInput, GetLineageGroupPolicyCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
