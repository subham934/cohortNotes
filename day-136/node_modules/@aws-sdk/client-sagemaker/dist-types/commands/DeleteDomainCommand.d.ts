...
import type { DeleteDomainRequest } from "../models/models_2";
...
declare const DeleteDomainCommand_base: {
    new (input: DeleteDomainCommandInput): import("@smithy/core/client").CommandImpl<DeleteDomainCommandInput, DeleteDomainCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteDomainCommandInput): import("@smithy/core/client").CommandImpl<DeleteDomainCommandInput, DeleteDomainCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
