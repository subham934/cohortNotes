...
import type { RenderUiTemplateRequest, RenderUiTemplateResponse } from "../models/models_4";
...
declare const RenderUiTemplateCommand_base: {
    new (input: RenderUiTemplateCommandInput): import("@smithy/core/client").CommandImpl<RenderUiTemplateCommandInput, RenderUiTemplateCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: RenderUiTemplateCommandInput): import("@smithy/core/client").CommandImpl<RenderUiTemplateCommandInput, RenderUiTemplateCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
