...
import type { DeleteActionRequest, DeleteActionResponse } from "../models/models_2";
...
declare const DeleteActionCommand_base: {
    new (input: DeleteActionCommandInput): import("@smithy/core/client").CommandImpl<DeleteActionCommandInput, DeleteActionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteActionCommandInput): import("@smithy/core/client").CommandImpl<DeleteActionCommandInput, DeleteActionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
