...
import type { DescribeAutoMLJobRequest, DescribeAutoMLJobResponse } from "../models/models_2";
...
declare const DescribeAutoMLJobCommand_base: {
    new (input: DescribeAutoMLJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeAutoMLJobCommandInput, DescribeAutoMLJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeAutoMLJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeAutoMLJobCommandInput, DescribeAutoMLJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
