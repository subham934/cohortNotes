...
import type { DescribePipelineExecutionRequest, DescribePipelineExecutionResponse } from "../models/models_3";
...
declare const DescribePipelineExecutionCommand_base: {
    new (input: DescribePipelineExecutionCommandInput): import("@smithy/core/client").CommandImpl<DescribePipelineExecutionCommandInput, DescribePipelineExecutionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribePipelineExecutionCommandInput): import("@smithy/core/client").CommandImpl<DescribePipelineExecutionCommandInput, DescribePipelineExecutionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
