...
import type { DescribeDeviceFleetRequest, DescribeDeviceFleetResponse } from "../models/models_2";
...
declare const DescribeDeviceFleetCommand_base: {
    new (input: DescribeDeviceFleetCommandInput): import("@smithy/core/client").CommandImpl<DescribeDeviceFleetCommandInput, DescribeDeviceFleetCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeDeviceFleetCommandInput): import("@smithy/core/client").CommandImpl<DescribeDeviceFleetCommandInput, DescribeDeviceFleetCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
