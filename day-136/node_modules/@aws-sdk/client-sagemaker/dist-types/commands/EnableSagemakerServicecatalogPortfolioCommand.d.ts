...
import type { EnableSagemakerServicecatalogPortfolioInput, EnableSagemakerServicecatalogPortfolioOutput } from "../models/models_3";
...
declare const EnableSagemakerServicecatalogPortfolioCommand_base: {
    new (input: EnableSagemakerServicecatalogPortfolioCommandInput): import("@smithy/core/client").CommandImpl<EnableSagemakerServicecatalogPortfolioCommandInput, EnableSagemakerServicecatalogPortfolioCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [EnableSagemakerServicecatalogPortfolioCommandInput]): import("@smithy/core/client").CommandImpl<EnableSagemakerServicecatalogPortfolioCommandInput, EnableSagemakerServicecatalogPortfolioCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
