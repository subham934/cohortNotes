...
import type { CreateModelBiasJobDefinitionRequest, CreateModelBiasJobDefinitionResponse } from "../models/models_1";
...
declare const CreateModelBiasJobDefinitionCommand_base: {
    new (input: CreateModelBiasJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<CreateModelBiasJobDefinitionCommandInput, CreateModelBiasJobDefinitionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateModelBiasJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<CreateModelBiasJobDefinitionCommandInput, CreateModelBiasJobDefinitionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
