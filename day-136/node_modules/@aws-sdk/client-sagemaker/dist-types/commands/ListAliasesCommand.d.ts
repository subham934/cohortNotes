...
import type { ListAliasesRequest, ListAliasesResponse } from "../models/models_3";
...
declare const ListAliasesCommand_base: {
    new (input: ListAliasesCommandInput): import("@smithy/core/client").CommandImpl<ListAliasesCommandInput, ListAliasesCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListAliasesCommandInput): import("@smithy/core/client").CommandImpl<ListAliasesCommandInput, ListAliasesCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
