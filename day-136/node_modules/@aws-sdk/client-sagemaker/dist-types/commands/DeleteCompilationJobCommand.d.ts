...
declare const DeleteCompilationJobCommand_base: {
    new (input: DeleteCompilationJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteCompilationJobCommandInput, DeleteCompilationJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteCompilationJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteCompilationJobCommandInput, DeleteCompilationJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
