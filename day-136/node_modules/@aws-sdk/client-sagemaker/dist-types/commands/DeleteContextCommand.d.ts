...
import type { DeleteContextRequest, DeleteContextResponse } from "../models/models_2";
...
declare const DeleteContextCommand_base: {
    new (input: DeleteContextCommandInput): import("@smithy/core/client").CommandImpl<DeleteContextCommandInput, DeleteContextCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteContextCommandInput): import("@smithy/core/client").CommandImpl<DeleteContextCommandInput, DeleteContextCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
