...
import type { CreateTrainingPlanRequest, CreateTrainingPlanResponse } from "../models/models_2";
...
declare const CreateTrainingPlanCommand_base: {
    new (input: CreateTrainingPlanCommandInput): import("@smithy/core/client").CommandImpl<CreateTrainingPlanCommandInput, CreateTrainingPlanCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateTrainingPlanCommandInput): import("@smithy/core/client").CommandImpl<CreateTrainingPlanCommandInput, CreateTrainingPlanCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
