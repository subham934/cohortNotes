...
import type { CreateInferenceRecommendationsJobRequest, CreateInferenceRecommendationsJobResponse } from "../models/models_1";
...
declare const CreateInferenceRecommendationsJobCommand_base: {
    new (input: CreateInferenceRecommendationsJobCommandInput): import("@smithy/core/client").CommandImpl<CreateInferenceRecommendationsJobCommandInput, CreateInferenceRecommendationsJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateInferenceRecommendationsJobCommandInput): import("@smithy/core/client").CommandImpl<CreateInferenceRecommendationsJobCommandInput, CreateInferenceRecommendationsJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
