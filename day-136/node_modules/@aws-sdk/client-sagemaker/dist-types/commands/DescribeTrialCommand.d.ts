...
import type { DescribeTrialRequest, DescribeTrialResponse } from "../models/models_3";
...
declare const DescribeTrialCommand_base: {
    new (input: DescribeTrialCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrialCommandInput, DescribeTrialCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeTrialCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrialCommandInput, DescribeTrialCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
