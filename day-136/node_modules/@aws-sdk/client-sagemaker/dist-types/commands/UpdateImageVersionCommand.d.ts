...
import type { UpdateImageVersionRequest, UpdateImageVersionResponse } from "../models/models_4";
...
declare const UpdateImageVersionCommand_base: {
    new (input: UpdateImageVersionCommandInput): import("@smithy/core/client").CommandImpl<UpdateImageVersionCommandInput, UpdateImageVersionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateImageVersionCommandInput): import("@smithy/core/client").CommandImpl<UpdateImageVersionCommandInput, UpdateImageVersionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
