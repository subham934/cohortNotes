...
import type { UpdateMlflowTrackingServerRequest, UpdateMlflowTrackingServerResponse } from "../models/models_4";
...
declare const UpdateMlflowTrackingServerCommand_base: {
    new (input: UpdateMlflowTrackingServerCommandInput): import("@smithy/core/client").CommandImpl<UpdateMlflowTrackingServerCommandInput, UpdateMlflowTrackingServerCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateMlflowTrackingServerCommandInput): import("@smithy/core/client").CommandImpl<UpdateMlflowTrackingServerCommandInput, UpdateMlflowTrackingServerCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
