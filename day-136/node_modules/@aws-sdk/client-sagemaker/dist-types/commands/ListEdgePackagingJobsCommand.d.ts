...
import type { ListEdgePackagingJobsRequest, ListEdgePackagingJobsResponse } from "../models/models_3";
...
declare const ListEdgePackagingJobsCommand_base: {
    new (input: ListEdgePackagingJobsCommandInput): import("@smithy/core/client").CommandImpl<ListEdgePackagingJobsCommandInput, ListEdgePackagingJobsCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListEdgePackagingJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListEdgePackagingJobsCommandInput, ListEdgePackagingJobsCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
