...
import type { SearchTrainingPlanOfferingsRequest, SearchTrainingPlanOfferingsResponse } from "../models/models_4";
...
declare const SearchTrainingPlanOfferingsCommand_base: {
    new (input: SearchTrainingPlanOfferingsCommandInput): import("@smithy/core/client").CommandImpl<SearchTrainingPlanOfferingsCommandInput, SearchTrainingPlanOfferingsCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [SearchTrainingPlanOfferingsCommandInput]): import("@smithy/core/client").CommandImpl<SearchTrainingPlanOfferingsCommandInput, SearchTrainingPlanOfferingsCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
