...
import type { UpdateEndpointWeightsAndCapacitiesInput, UpdateEndpointWeightsAndCapacitiesOutput } from "../models/models_4";
...
declare const UpdateEndpointWeightsAndCapacitiesCommand_base: {
    new (input: UpdateEndpointWeightsAndCapacitiesCommandInput): import("@smithy/core/client").CommandImpl<UpdateEndpointWeightsAndCapacitiesCommandInput, UpdateEndpointWeightsAndCapacitiesCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateEndpointWeightsAndCapacitiesCommandInput): import("@smithy/core/client").CommandImpl<UpdateEndpointWeightsAndCapacitiesCommandInput, UpdateEndpointWeightsAndCapacitiesCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
