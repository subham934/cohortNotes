...
import type { ListComputeQuotasRequest, ListComputeQuotasResponse } from "../models/models_3";
...
declare const ListComputeQuotasCommand_base: {
    new (input: ListComputeQuotasCommandInput): import("@smithy/core/client").CommandImpl<ListComputeQuotasCommandInput, ListComputeQuotasCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListComputeQuotasCommandInput]): import("@smithy/core/client").CommandImpl<ListComputeQuotasCommandInput, ListComputeQuotasCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
