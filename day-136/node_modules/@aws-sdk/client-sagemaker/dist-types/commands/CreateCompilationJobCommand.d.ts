...
import type { CreateCompilationJobRequest, CreateCompilationJobResponse } from "../models/models_1";
...
declare const CreateCompilationJobCommand_base: {
    new (input: CreateCompilationJobCommandInput): import("@smithy/core/client").CommandImpl<CreateCompilationJobCommandInput, CreateCompilationJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateCompilationJobCommandInput): import("@smithy/core/client").CommandImpl<CreateCompilationJobCommandInput, CreateCompilationJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
