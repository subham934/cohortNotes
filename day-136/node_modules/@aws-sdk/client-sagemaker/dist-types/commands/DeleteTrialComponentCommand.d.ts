...
import type { DeleteTrialComponentRequest, DeleteTrialComponentResponse } from "../models/models_2";
...
declare const DeleteTrialComponentCommand_base: {
    new (input: DeleteTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrialComponentCommandInput, DeleteTrialComponentCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<DeleteTrialComponentCommandInput, DeleteTrialComponentCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
