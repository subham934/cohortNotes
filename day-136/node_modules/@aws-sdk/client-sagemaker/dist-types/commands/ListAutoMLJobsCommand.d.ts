...
import type { ListAutoMLJobsRequest, ListAutoMLJobsResponse } from "../models/models_3";
...
declare const ListAutoMLJobsCommand_base: {
    new (input: ListAutoMLJobsCommandInput): import("@smithy/core/client").CommandImpl<ListAutoMLJobsCommandInput, ListAutoMLJobsCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListAutoMLJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListAutoMLJobsCommandInput, ListAutoMLJobsCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
