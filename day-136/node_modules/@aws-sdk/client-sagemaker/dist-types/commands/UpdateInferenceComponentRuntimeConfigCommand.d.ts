...
import type { UpdateInferenceComponentRuntimeConfigInput, UpdateInferenceComponentRuntimeConfigOutput } from "../models/models_4";
...
declare const UpdateInferenceComponentRuntimeConfigCommand_base: {
    new (input: UpdateInferenceComponentRuntimeConfigCommandInput): import("@smithy/core/client").CommandImpl<UpdateInferenceComponentRuntimeConfigCommandInput, UpdateInferenceComponentRuntimeConfigCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateInferenceComponentRuntimeConfigCommandInput): import("@smithy/core/client").CommandImpl<UpdateInferenceComponentRuntimeConfigCommandInput, UpdateInferenceComponentRuntimeConfigCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
