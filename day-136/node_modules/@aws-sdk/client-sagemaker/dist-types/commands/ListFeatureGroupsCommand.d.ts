...
import type { ListFeatureGroupsRequest, ListFeatureGroupsResponse } from "../models/models_3";
...
declare const ListFeatureGroupsCommand_base: {
    new (input: ListFeatureGroupsCommandInput): import("@smithy/core/client").CommandImpl<ListFeatureGroupsCommandInput, ListFeatureGroupsCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListFeatureGroupsCommandInput]): import("@smithy/core/client").CommandImpl<ListFeatureGroupsCommandInput, ListFeatureGroupsCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
