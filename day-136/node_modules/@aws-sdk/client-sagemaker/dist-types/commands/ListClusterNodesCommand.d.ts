...
import type { ListClusterNodesRequest, ListClusterNodesResponse } from "../models/models_3";
...
declare const ListClusterNodesCommand_base: {
    new (input: ListClusterNodesCommandInput): import("@smithy/core/client").CommandImpl<ListClusterNodesCommandInput, ListClusterNodesCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListClusterNodesCommandInput): import("@smithy/core/client").CommandImpl<ListClusterNodesCommandInput, ListClusterNodesCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
