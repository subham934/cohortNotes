...
declare const DescribeCompilationJobCommand_base: {
    new (input: DescribeCompilationJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeCompilationJobCommandInput, DescribeCompilationJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeCompilationJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeCompilationJobCommandInput, DescribeCompilationJobCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
