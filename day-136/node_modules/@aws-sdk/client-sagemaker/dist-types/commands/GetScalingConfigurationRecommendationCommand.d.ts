...
import type { GetScalingConfigurationRecommendationRequest, GetScalingConfigurationRecommendationResponse } from "../models/models_3";
...
declare const GetScalingConfigurationRecommendationCommand_base: {
    new (input: GetScalingConfigurationRecommendationCommandInput): import("@smithy/core/client").CommandImpl<GetScalingConfigurationRecommendationCommandInput, GetScalingConfigurationRecommendationCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetScalingConfigurationRecommendationCommandInput): import("@smithy/core/client").CommandImpl<GetScalingConfigurationRecommendationCommandInput, GetScalingConfigurationRecommendationCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
