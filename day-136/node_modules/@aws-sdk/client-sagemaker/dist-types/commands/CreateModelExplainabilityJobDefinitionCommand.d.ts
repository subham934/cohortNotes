...
import type { CreateModelExplainabilityJobDefinitionRequest, CreateModelExplainabilityJobDefinitionResponse } from "../models/models_1";
...
declare const CreateModelExplainabilityJobDefinitionCommand_base: {
    new (input: CreateModelExplainabilityJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<CreateModelExplainabilityJobDefinitionCommandInput, CreateModelExplainabilityJobDefinitionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateModelExplainabilityJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<CreateModelExplainabilityJobDefinitionCommandInput, CreateModelExplainabilityJobDefinitionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
