...
import type { DescribeEdgeDeploymentPlanRequest, DescribeEdgeDeploymentPlanResponse } from "../models/models_2";
...
declare const DescribeEdgeDeploymentPlanCommand_base: {
    new (input: DescribeEdgeDeploymentPlanCommandInput): import("@smithy/core/client").CommandImpl<DescribeEdgeDeploymentPlanCommandInput, DescribeEdgeDeploymentPlanCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeEdgeDeploymentPlanCommandInput): import("@smithy/core/client").CommandImpl<DescribeEdgeDeploymentPlanCommandInput, DescribeEdgeDeploymentPlanCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
