...
import type { DescribeSpaceRequest, DescribeSpaceResponse } from "../models/models_3";
...
declare const DescribeSpaceCommand_base: {
    new (input: DescribeSpaceCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpaceCommandInput, DescribeSpaceCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeSpaceCommandInput): import("@smithy/core/client").CommandImpl<DescribeSpaceCommandInput, DescribeSpaceCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
