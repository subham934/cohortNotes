...
import type { DescribeDataQualityJobDefinitionRequest, DescribeDataQualityJobDefinitionResponse } from "../models/models_2";
...
declare const DescribeDataQualityJobDefinitionCommand_base: {
    new (input: DescribeDataQualityJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DescribeDataQualityJobDefinitionCommandInput, DescribeDataQualityJobDefinitionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeDataQualityJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<DescribeDataQualityJobDefinitionCommandInput, DescribeDataQualityJobDefinitionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
