...
import type { CreateInferenceExperimentRequest, CreateInferenceExperimentResponse } from "../models/models_1";
...
declare const CreateInferenceExperimentCommand_base: {
    new (input: CreateInferenceExperimentCommandInput): import("@smithy/core/client").CommandImpl<CreateInferenceExperimentCommandInput, CreateInferenceExperimentCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateInferenceExperimentCommandInput): import("@smithy/core/client").CommandImpl<CreateInferenceExperimentCommandInput, CreateInferenceExperimentCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
