...
import type { DescribeSubscribedWorkteamRequest, DescribeSubscribedWorkteamResponse } from "../models/models_3";
...
declare const DescribeSubscribedWorkteamCommand_base: {
    new (input: DescribeSubscribedWorkteamCommandInput): import("@smithy/core/client").CommandImpl<DescribeSubscribedWorkteamCommandInput, DescribeSubscribedWorkteamCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeSubscribedWorkteamCommandInput): import("@smithy/core/client").CommandImpl<DescribeSubscribedWorkteamCommandInput, DescribeSubscribedWorkteamCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
