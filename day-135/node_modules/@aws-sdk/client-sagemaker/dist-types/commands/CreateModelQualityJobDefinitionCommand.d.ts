...
import type { CreateModelQualityJobDefinitionRequest, CreateModelQualityJobDefinitionResponse } from "../models/models_1";
...
declare const CreateModelQualityJobDefinitionCommand_base: {
    new (input: CreateModelQualityJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<CreateModelQualityJobDefinitionCommandInput, CreateModelQualityJobDefinitionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateModelQualityJobDefinitionCommandInput): import("@smithy/core/client").CommandImpl<CreateModelQualityJobDefinitionCommandInput, CreateModelQualityJobDefinitionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
