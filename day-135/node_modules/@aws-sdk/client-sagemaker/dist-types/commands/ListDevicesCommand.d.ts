...
import type { ListDevicesRequest, ListDevicesResponse } from "../models/models_3";
...
declare const ListDevicesCommand_base: {
    new (input: ListDevicesCommandInput): import("@smithy/core/client").CommandImpl<ListDevicesCommandInput, ListDevicesCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListDevicesCommandInput]): import("@smithy/core/client").CommandImpl<ListDevicesCommandInput, ListDevicesCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
