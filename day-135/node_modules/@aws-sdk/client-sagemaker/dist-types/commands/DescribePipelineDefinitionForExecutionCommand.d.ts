...
import type { DescribePipelineDefinitionForExecutionRequest, DescribePipelineDefinitionForExecutionResponse } from "../models/models_3";
...
declare const DescribePipelineDefinitionForExecutionCommand_base: {
    new (input: DescribePipelineDefinitionForExecutionCommandInput): import("@smithy/core/client").CommandImpl<DescribePipelineDefinitionForExecutionCommandInput, DescribePipelineDefinitionForExecutionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribePipelineDefinitionForExecutionCommandInput): import("@smithy/core/client").CommandImpl<DescribePipelineDefinitionForExecutionCommandInput, DescribePipelineDefinitionForExecutionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
