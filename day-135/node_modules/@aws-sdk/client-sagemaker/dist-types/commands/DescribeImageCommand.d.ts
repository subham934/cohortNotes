...
import type { DescribeImageRequest, DescribeImageResponse } from "../models/models_2";
...
declare const DescribeImageCommand_base: {
    new (input: DescribeImageCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageCommandInput, DescribeImageCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeImageCommandInput): import("@smithy/core/client").CommandImpl<DescribeImageCommandInput, DescribeImageCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
