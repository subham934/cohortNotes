...
import type { DescribeComputeQuotaRequest, DescribeComputeQuotaResponse } from "../models/models_2";
...
declare const DescribeComputeQuotaCommand_base: {
    new (input: DescribeComputeQuotaCommandInput): import("@smithy/core/client").CommandImpl<DescribeComputeQuotaCommandInput, DescribeComputeQuotaCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeComputeQuotaCommandInput): import("@smithy/core/client").CommandImpl<DescribeComputeQuotaCommandInput, DescribeComputeQuotaCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
