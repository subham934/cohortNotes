...
import type { DescribeTrialComponentRequest, DescribeTrialComponentResponse } from "../models/models_3";
...
declare const DescribeTrialComponentCommand_base: {
    new (input: DescribeTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrialComponentCommandInput, DescribeTrialComponentCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeTrialComponentCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrialComponentCommandInput, DescribeTrialComponentCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
