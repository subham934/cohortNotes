...
import type { CreateCodeRepositoryInput, CreateCodeRepositoryOutput } from "../models/models_1";
...
declare const CreateCodeRepositoryCommand_base: {
    new (input: CreateCodeRepositoryCommandInput): import("@smithy/core/client").CommandImpl<CreateCodeRepositoryCommandInput, CreateCodeRepositoryCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateCodeRepositoryCommandInput): import("@smithy/core/client").CommandImpl<CreateCodeRepositoryCommandInput, CreateCodeRepositoryCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
