...
import type { UpdateHubContentRequest, UpdateHubContentResponse } from "../models/models_4";
...
declare const UpdateHubContentCommand_base: {
    new (input: UpdateHubContentCommandInput): import("@smithy/core/client").CommandImpl<UpdateHubContentCommandInput, UpdateHubContentCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateHubContentCommandInput): import("@smithy/core/client").CommandImpl<UpdateHubContentCommandInput, UpdateHubContentCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
