...
import type { GetModelPackageGroupPolicyInput, GetModelPackageGroupPolicyOutput } from "../models/models_3";
...
declare const GetModelPackageGroupPolicyCommand_base: {
    new (input: GetModelPackageGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetModelPackageGroupPolicyCommandInput, GetModelPackageGroupPolicyCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetModelPackageGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetModelPackageGroupPolicyCommandInput, GetModelPackageGroupPolicyCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
