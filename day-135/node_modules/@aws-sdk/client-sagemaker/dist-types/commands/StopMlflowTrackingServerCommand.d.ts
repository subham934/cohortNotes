...
import type { StopMlflowTrackingServerRequest, StopMlflowTrackingServerResponse } from "../models/models_4";
...
declare const StopMlflowTrackingServerCommand_base: {
    new (input: StopMlflowTrackingServerCommandInput): import("@smithy/core/client").CommandImpl<StopMlflowTrackingServerCommandInput, StopMlflowTrackingServerCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: StopMlflowTrackingServerCommandInput): import("@smithy/core/client").CommandImpl<StopMlflowTrackingServerCommandInput, StopMlflowTrackingServerCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
