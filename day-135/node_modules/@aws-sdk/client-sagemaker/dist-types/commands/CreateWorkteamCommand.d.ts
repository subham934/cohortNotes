...
import type { CreateWorkteamRequest, CreateWorkteamResponse } from "../models/models_2";
...
declare const CreateWorkteamCommand_base: {
    new (input: CreateWorkteamCommandInput): import("@smithy/core/client").CommandImpl<CreateWorkteamCommandInput, CreateWorkteamCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateWorkteamCommandInput): import("@smithy/core/client").CommandImpl<CreateWorkteamCommandInput, CreateWorkteamCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
