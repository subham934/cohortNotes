...
import type { DescribeAppRequest, DescribeAppResponse } from "../models/models_2";
...
declare const DescribeAppCommand_base: {
    new (input: DescribeAppCommandInput): import("@smithy/core/client").CommandImpl<DescribeAppCommandInput, DescribeAppCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeAppCommandInput): import("@smithy/core/client").CommandImpl<DescribeAppCommandInput, DescribeAppCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
