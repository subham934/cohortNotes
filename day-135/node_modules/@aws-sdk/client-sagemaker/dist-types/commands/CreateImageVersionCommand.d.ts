...
import type { CreateImageVersionRequest, CreateImageVersionResponse } from "../models/models_1";
...
declare const CreateImageVersionCommand_base: {
    new (input: CreateImageVersionCommandInput): import("@smithy/core/client").CommandImpl<CreateImageVersionCommandInput, CreateImageVersionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateImageVersionCommandInput): import("@smithy/core/client").CommandImpl<CreateImageVersionCommandInput, CreateImageVersionCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
