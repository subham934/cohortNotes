...
import type { DescribeStudioLifecycleConfigRequest, DescribeStudioLifecycleConfigResponse } from "../models/models_3";
...
declare const DescribeStudioLifecycleConfigCommand_base: {
    new (input: DescribeStudioLifecycleConfigCommandInput): import("@smithy/core/client").CommandImpl<DescribeStudioLifecycleConfigCommandInput, DescribeStudioLifecycleConfigCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeStudioLifecycleConfigCommandInput): import("@smithy/core/client").CommandImpl<DescribeStudioLifecycleConfigCommandInput, DescribeStudioLifecycleConfigCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
