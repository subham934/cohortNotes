...
import type { DescribeInferenceExperimentRequest, DescribeInferenceExperimentResponse } from "../models/models_3";
...
declare const DescribeInferenceExperimentCommand_base: {
    new (input: DescribeInferenceExperimentCommandInput): import("@smithy/core/client").CommandImpl<DescribeInferenceExperimentCommandInput, DescribeInferenceExperimentCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeInferenceExperimentCommandInput): import("@smithy/core/client").CommandImpl<DescribeInferenceExperimentCommandInput, DescribeInferenceExperimentCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
