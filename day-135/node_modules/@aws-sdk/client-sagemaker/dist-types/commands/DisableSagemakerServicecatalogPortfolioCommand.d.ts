...
import type { DisableSagemakerServicecatalogPortfolioInput, DisableSagemakerServicecatalogPortfolioOutput } from "../models/models_3";
...
declare const DisableSagemakerServicecatalogPortfolioCommand_base: {
    new (input: DisableSagemakerServicecatalogPortfolioCommandInput): import("@smithy/core/client").CommandImpl<DisableSagemakerServicecatalogPortfolioCommandInput, DisableSagemakerServicecatalogPortfolioCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DisableSagemakerServicecatalogPortfolioCommandInput]): import("@smithy/core/client").CommandImpl<DisableSagemakerServicecatalogPortfolioCommandInput, DisableSagemakerServicecatalogPortfolioCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
