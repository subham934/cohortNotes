...
import type { DeleteImageRequest, DeleteImageResponse } from "../models/models_2";
...
declare const DeleteImageCommand_base: {
    new (input: DeleteImageCommandInput): import("@smithy/core/client").CommandImpl<DeleteImageCommandInput, DeleteImageCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteImageCommandInput): import("@smithy/core/client").CommandImpl<DeleteImageCommandInput, DeleteImageCommandOutput, SageMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
